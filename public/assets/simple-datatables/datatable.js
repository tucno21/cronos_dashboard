												...
												case s._const.addTextElement:
													...
													((l = {}).nodeName = "#text"),
														...
														n.subsets &&
															n.subsets.forEach(function (t) {
																if (
																	(t.oldValue >= p && (t.oldValue += 1), t.oldValue < p && t.oldValue + t.length > p)
																) {
										...
										return (
											...
											(g.startOf = function (t, e) {
												var s = this,
													...
													f = function (t, e) {
														return N.w(
															s.toDate()[t].apply(s.toDate("s"), (d ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)),
															s
														);
													},
													m = this.$W,
									...
									t.headings
										...
										? (o.headings = Array.from(e.tHead.querySelectorAll("th")).map((t, e) => {
												const o = ((t) => {
													...
													return (
														(s =
															!e.childNodes || (1 === e.childNodes.length && "#text" === e.childNodes[0].nodeName)
								...
								init() {
									[this.settings, this._state] = ((t = [], e, s) => {
										...
										return (
											t.forEach((t) => {
												(Array.isArray(t.select) ? t.select : [t.select]).forEach((o) => {
													...
													t.render && (r.render = t.render),
														...
														!1 === t.sortable
															? (r.sortable = !1)
															: (t.numeric && (r.numeric = t.numeric), t.caseFirst && (r.caseFirst = t.caseFirst)),
														!1 === t.searchable
															? (r.searchable = !1)
											...
											(i = i.map(
												(t) => t || { type: e, format: "date" === e ? s : void 0, sortable: !0, searchable: !0 }
											)),
								...
								(s.exportJSON = function (t, s = {}) {
									...
									if (i.selection)
										if (Array.isArray(i.selection))
											for (let e = 0; e < i.selection.length; e++)
												a = a.concat(
													t.pages[i.selection[e] - 1].map((t) => t.row.filter((t, e) => n(e)).map((t) => t.data))
												);
										else
											a = a.concat(
